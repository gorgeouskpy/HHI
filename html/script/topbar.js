    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 topbar">
                ...
                <span class="document" onclick="window.open('/docs.html',true)">文档&nbsp<span class="fa fa-book"></span></span>
                <span class="event" onclick="window.open('/event.html',true)">大事记&nbsp<span class="fa fa-bookmark"></span></span>
            </div>
        </div>
    </div>
    `,
